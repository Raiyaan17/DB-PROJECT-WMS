...
-- Execute the procedure to create the partitioned table and its components
PRINT 'Executing procedure to set up partitioned Std.Student table...';
EXEC dbo.SetupStudentTablePartitioning;
GO

-- Drop the procedure to clean up the database
PRINT 'Cleaning up setup procedure...';
