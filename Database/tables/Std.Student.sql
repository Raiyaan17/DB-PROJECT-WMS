...
-- This script creates the partition function, partition scheme, and the Std.Student table.
-- The table is partitioned by GraduationYear.
...
BEGIN
    ...
    CREATE TABLE Std.Student (
        ...
        -- Email should be unique across all students, but for a partitioned table,
        -- the partitioning key (GraduationYear) must be part of the unique index.
        CONSTRAINT uq_student_email UNIQUE (Email, GraduationYear),
